...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLifecycleLibraryAccessors extends SubDependencyFactory {
        ...
        private final AndroidxLifecycleViewLibraryAccessors laccForAndroidxLifecycleViewLibraryAccessors = new AndroidxLifecycleViewLibraryAccessors(owner);
        ...
        /**
         * Returns the group of libraries at androidx.lifecycle.view
         */
        public AndroidxLifecycleViewLibraryAccessors getView() {
            return laccForAndroidxLifecycleViewLibraryAccessors;
        }
    ...
    public static class AndroidxLifecycleViewLibraryAccessors extends SubDependencyFactory {
        private final AndroidxLifecycleViewModelLibraryAccessors laccForAndroidxLifecycleViewModelLibraryAccessors = new AndroidxLifecycleViewModelLibraryAccessors(owner);

        public AndroidxLifecycleViewLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at androidx.lifecycle.view.model
         */
        public AndroidxLifecycleViewModelLibraryAccessors getModel() {
    ...
    public static class AndroidxLifecycleViewModelLibraryAccessors extends SubDependencyFactory {
        ...
        public AndroidxLifecycleViewModelLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
            ...
            /**
             * Creates a dependency provider for ktx (androidx.lifecycle:lifecycle-view-model-ktx)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getKtx() {
                return create("androidx.lifecycle.view.model.ktx");
        }
    ...
    public static class LifecycleVersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.lifecycle.view
         */
    ...
    public static class LifecycleRuntimeVersionAccessors extends VersionFactory  {
        ...
        public LifecycleRuntimeVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: lifecycle.runtime.ktx (2.8.7)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
    ...
    public static class LifecycleViewVersionAccessors extends VersionFactory  {
        ...
        /**
         * Returns the group of versions at versions.lifecycle.view.model
         */
    ...
    public static class LifecycleViewModelVersionAccessors extends VersionFactory  {
        ...
        public LifecycleViewModelVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: lifecycle.view.model.ktx (2.8.0)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKtx() { return getVersion("lifecycle.view.model.ktx"); }
